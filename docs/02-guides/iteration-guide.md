...
> 本文件为 ITERATION_GUIDE.md 迁移实体，归属 docs/02-guides/iteration-guide.md，原始行数 349，已按 ≤120 wrap。
...
| |
| `ASSET_REGISTRY.md`   | 写入 `\| ID \| 名称 \| 类型 \| 风格 \| 模型 \| Seed \| Subject \| 状态 \| 路径 \| 备注 \|`（Markdown 表格头，
| 去掉反斜杠） |

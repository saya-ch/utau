...
- [x] T070 **[候选]** Code 存档系统持久化磁盘版：SaveSystem autoload + 3 手动槽/1 auto slot + SaveLoadMenu UI + GameState 序列化 + TitleScreen 继续修复按钮 + SaveLantern 触发自动存档 (50min) <!-- 2026-06-04 05:00 -->

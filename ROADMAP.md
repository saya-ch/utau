...
下一轮（#88，N%5=3，普通模式）建议候选（Polish + 文档 + Refactor 路线延续）：
...
- T164 [候选] Polish InkWarden "phase 3" dissolve 0.20s 出 + 0.25s 入 tween（**#85 #86 #87 因 phase 3 锚定不明连续延后** —— 当前 ink_warden.gd 候选 "phase 3" 究竟是 _break_shield / _enter_stun / _purify 三选一，**先确定锚点**再设计 dissolve 路径）(10min)
- T170 [候选] Polish 4 verb 命中 VFX 路线（与 T166/T167/T168/T169 windup 路线对偶）：Cut 命中屏抖 / Pulse 命中 bounce flash / Bind 命中聚拢 ring / Echo 命中反射 spark 候选，从最敏感的"Cut 命中"开始（**Cut 是 4 verb 中命中反馈最弱的**——目前 cut_fired 之后仅 cut_vfx.gd 弧线斩击，无屏抖无 flash 无 bounce，玩家"打到没打到"认知模糊）(10min)

...
- [ ] T029 Code 实现共鸣碎片拾取物（ResonanceShard）：掉落物物理、吸引、收集动画 (30min)
- [ ] T030 Code 实现精英敌人 InkWarden：高血量、护盾、破盾后眩晕 (50min)
- [ ] T031 Art 生成 InkWarden 精英敌人素材 (35min)
- [ ] T032 Code 实现第二个声波能力 Bind（牵引/暂停）：新输入键、新 VFX、新交互 (55min)
...
- [ ] T037 Code 实现设置菜单：音量、分辨率、按键重映射 (35min)

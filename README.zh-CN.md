...
**5 verb 音频闭环现状**（#94 F004 + #96 F004.B）：Pulse fire（F004）+ Bind/Cut/Echo/Wave fire 4 SFX（F004.B）全部 `AudioManagerEnhanced.play_*()` 定义完成。剩余 T181 候选闭环：5 verb hit audio + 5 verb cooldown audio + 4 verb ability caller 接入。

...
**5 verb 音频闭环现状**（#94 F004 + #96 F004.B + #97 T181）：5 verb fire caller (T181 first half) + 5 verb fire SFX (F004 + F004.B) + 5 verb hit SFX (T141 #78 wave_combo + T181 first half 4 verb) + 5 verb cooldown jingle (T181 first half) 全部 15/15 cue 就位。剩余 T181 second half 候选：5 verb hit 主题色 perk-level scaling（10min）+ 5 verb audio A/B-test（5min）。

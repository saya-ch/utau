...
#
# This wrapper:
#   1. Preloads all 60 RefCounted test classes
...
# 0 触碰 60 RefCounted test class 任何 1 字符 (T306-T319 + T321 + T322 + T323 + T324 + T325 + T326 + T327 + T328 + T329 + T330 + T331 + T332 + T333 + T334 + T335 + T336 + T337 + T338 + T339 + T340 + T341 + T342 + T343 + T344 + T345 + T346 + T347 + T348 + T349 + T350 + T351 + T352 + T353 + T354 + T355 + T356 + T357 + T358 + T359 + T360 + T361 + T362 + T363 + T364 + T366 + T367 + T368).
...
func _initialize() -> void:
	...
	if any_failed:
		...
		print("[REFCOUNTED RUNNER PASSED] 60 RefCounted smoke tests all green")
		quit(0)

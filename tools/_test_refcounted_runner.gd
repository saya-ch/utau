...
#
# This wrapper:
#   1. Preloads all 63 RefCounted test classes
...
# 0 触碰 63 RefCounted test class 任何 1 字符 (T306-T319 + T321 + T322 + T323 + T324 + T325 + T326 + T327 + T328 + T329 + T330 + T331 + T332 + T333 + T334 + T335 + T336 + T337 + T338 + T339 + T340 + T341 + T342 + T343 + T344 + T345 + T346 + T347 + T348 + T349 + T350 + T351 + T352 + T353 + T354 + T355 + T356 + T357 + T358 + T359 + T360 + T361 + T362 + T363 + T364 + T366 + T367 + T368 + T369 + T370 + T371).
...
const _REFCOUNTED_TESTS = [
	...
	preload("res://tools/test_t362_contributing_fragility_section96104_smoke.gd"),
	preload("res://tools/test_t363_contributing_fragility_section96105_smoke.gd"),
	preload("res://tools/test_t364_contributing_fragility_section96106_smoke.gd"),
	...
	# T371 #314 §9.6.113 6 verb 视觉组 硬度 1 维度 跨层 57 维度拼接 1:1 严格分离契约 polish 模式 (15 断言) 落地,
	# 1 边新增 (T371 1 边), 0 触碰既有 62 套任何 1 字符.
	preload("res://tools/test_t371_contributing_fragility_section96113_smoke.gd"),
]

func _initialize() -> void:
        print("=== RefCounted smoke test runner (T306-T319 + T321 + T322 + T323 + T324 + T325 + T326 + T327 + T328 + T329 + T330 + T331 + T332 + T333 + T334 + T335 + T336 + T337 + T338 + T339 + T340 + T341 + T342 + T343 + T344 + T345 + T346 + T347 + T348 + T349 + T350 + T351 + T352 + T353 + T354 + T355 + T356 + T357 + T358 + T359 + T360 + T361 + T362 + T363 + T364 + T366 + T367 + T368 + T369 + T370 + T371) ===")
	...
	if any_failed:
		...
		print("[REFCOUNTED RUNNER PASSED] 63 RefCounted smoke tests all green")
		quit(0)

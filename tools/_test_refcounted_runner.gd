extends SceneTree
# _test_refcounted_runner.gd — Runner for 33 `extends RefCounted` smoke tests
...
#
# This wrapper:
#   1. Preloads all 33 RefCounted test classes
...
# 0 触碰 33 RefCounted test class 任何 1 字符 (T306-T319 + T321 + T322 + T323 + T324 + T325 + T326 + T327 + T328 + T329 + T330 + T331 + T332 + T333 + T334 + T335 + T336 + T337 + T338 + T339 + T340 + T341).
...
func _initialize() -> void:
	print("=== RefCounted smoke test runner (T306-T319 + T321 + T322 + T323 + T324 + T325 + T326 + T327 + T328 + T329 + T330 + T331 + T332 + T333 + T334 + T335 + T336 + T337 + T338 + T339 + T340 + T341) ===")
	...
	if any_failed:
		...
		print("[REFCOUNTED RUNNER PASSED] 34 RefCounted smoke tests all green")
		quit(0)

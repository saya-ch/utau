extends SceneTree
# _test_refcounted_runner.gd — Runner for 27 `extends RefCounted` smoke tests
# (T306 #233 + T307 #234 + T308 #236 + T309 #237 + T310 #238 + T311 #239 + T312 #241 + T313 #242 + T315 #244 + T316 #246 + T317 #247 + T318 #248 + T319 #249 + T321 #251 + T322 #252 + T323 #253 + T324 #254 + T325 #256 + T326 #257 + T327 #258 + T328 #259 + T329 #261 + T330 #262 + T331 #263 + T332 #264 + T333 #266 + T334 #267).
...
#
# This wrapper:
#   1. Preloads all 27 RefCounted test classes
...
# 0 触碰 27 RefCounted test class 任何 1 字符 (T306-T319 + T321 + T322 + T323 + T324 + T325 + T326 + T327 + T328 + T329 + T330 + T331 + T332 + T333 + T334).
...
func _initialize() -> void:
	print("=== RefCounted smoke test runner (T306-T319 + T321 + T322 + T323 + T324 + T325 + T326 + T327 + T328 + T329 + T330 + T331 + T332 + T333 + T334) ===")
	...
	if any_failed:
		...
		print("[REFCOUNTED RUNNER PASSED] 27 RefCounted smoke tests all green")
		quit(0)

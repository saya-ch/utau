extends SceneTree
# _test_refcounted_runner.gd — Runner for 42 `extends RefCounted` smoke tests
...
#
# This wrapper:
#   1. Preloads all 42 RefCounted test classes
...
# 0 触碰 42 RefCounted test class 任何 1 字符 (T306-T319 + T321 + T322 + T323 + T324 + T325 + T326 + T327 + T328 + T329 + T330 + T331 + T332 + T333 + T334 + T335 + T336 + T337 + T338 + T339 + T340 + T341 + T342 + T343 + T344 + T345 + T346 + T347 + T348 + T349 + T350).
...
func _initialize() -> void:
	...
	if any_failed:
		...
		print("[REFCOUNTED RUNNER PASSED] 42 RefCounted smoke tests all green")
		quit(0)
